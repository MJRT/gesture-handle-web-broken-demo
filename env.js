 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.allin-notes-app.staging
 */

// TODO: Replace these values with your own

const BUNDLE_ID = 'com.app.app'; // ios bundle id
const PACKAGE = 'com.app.app'; // android package name
const NAME = 'app'; // app name
const EXPO_ACCOUNT_OWNER = ''; // expo account owner
const EAS_PROJECT_ID = ''; // e
...
const _clientEnv = {
  ...
  WEB_PROXY_URL: process.env.WEB_PROXY_URL,
  RQLITE_URL: process.env.RQLITE_URL,
};
